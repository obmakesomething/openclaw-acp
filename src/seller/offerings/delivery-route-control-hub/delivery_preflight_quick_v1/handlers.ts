...
const OFFERING_NAME = "delivery_preflight_quick_v1";
const PLAN = "quick";
    ...
    deliverable: {
      ...
      value: {
        ...
        nextAction: {
          ...
          jobOfferingName: "o2o_delivery_quote_quick_v1",
          serviceRequirements: {
            mode: "o2o",
            plan: "quick",
...
export function requestPayment(request: any): string {
  return "Delivery routing quick plan accepted. Proceeding to orchestration output.";
}
