...
const OFFERING_NAME = "virtuals_event_raffle_kr";
const OFFER_ENDPOINT = "/raffle/offer";
const RAFFLE_BASE_URL =
  "https://virtuals-event-raffle-kr-production.up.railway.app";
...
export async function executeJob(request: any): Promise<ExecuteJobResult> {
  ...
  return {
    deliverable: {
      type: "json",
      value: {
        service: "virtuals-event-raffle-kr",
        offering: OFFERING_NAME,
        locale: request?.locale || "ko-KR",
        country: request?.country || "KR",
        upstream,
      },
    },
  };
