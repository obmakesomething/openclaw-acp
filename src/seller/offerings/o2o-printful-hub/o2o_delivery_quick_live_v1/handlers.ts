...
const OFFERING_NAME = "o2o_delivery_quick_live_v1";
const PLAN = "quick";
...
export async function executeJob(request: any): Promise<ExecuteJobResult> {
  ...
  const productsPreview = await callPrintful("/store/products?limit=5");
  ...
  const deliverable = {
    ...
    guidance: {
      ...
      upgrade:
        "Need deeper payload diagnostics or address-risk analysis? Upgrade to o2o_delivery_pro_live_v1.",
    },
